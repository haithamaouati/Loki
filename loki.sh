...
# Input: Phishing URL
echo -e "${faint}Paste Phishing URL (with http or https)${normal}"
...
echo -e "${faint}Domain to mask the Phishing URL (with http or https)${normal}"
read -p "Masking domain: " mask
url_checker "$mask"

# Input: Social engineering words
echo -e "${faint}Type social engineering words (earn-money, no spaces)${normal}"
